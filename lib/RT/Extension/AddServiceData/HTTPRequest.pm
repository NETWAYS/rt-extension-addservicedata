package RT::Extension::AddServiceData::HTTPRequest;
...
require RT::Extension::AddServiceData::GenericRequest;


use base qw (RT::Extension::AddServiceData::GenericRequest);
